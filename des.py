...
output_path_predict = "/home/lrikozavr/catalogs/des/predict"

inform_path = '/home/lrikozavr/github/extragalactic_object_locate_with_ml/ml/model'
...
output_path_mod = f"{inform_path}/mod_extragal_custom_15015012.0"
output_path_weight = f"{inform_path}/weight_extragal_custom_15015012.0"
...
#										ClassStar	  191 192 193 194 195
    ...
    features=['g_MagA','r_MagA','i_MagA','z_MagA','Y_MagA']
